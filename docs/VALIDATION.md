...
**Limits.** No live scan was made to block a cancellation callback or exceed the close bound; both remain deterministic-only. The Alt+Tab check depends on the desktop's window order. No screen reader was run. These fixes were made by the implementer and have not been independently re-reviewed.
