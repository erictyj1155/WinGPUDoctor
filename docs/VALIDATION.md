...
After both fixes `./scripts/dev.ps1 -Action test` passed outside the sandbox: Release build 0 warnings and 0 errors, xUnit **368/368**, schema and all helper checks. An active high-contrast theme is checked live in the Step 5 batch below.
