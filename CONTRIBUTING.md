...
1. Read `ARCHITECTURE.md`, `PRIVACY.md`, the API feasibility matrix, and the relevant ADR before changing behavior.
...
3. Keep Windows API access in the Windows assembly. Core rules, privacy, and writers must remain independent of WMI, hardware, or GUI frameworks.
