...
- Dependencies are versioned/locked; CI uses read-only repository permissions and does not attach live hardware reports. Check the GitHub Actions run history for hosted CI results once an upstream exists.
